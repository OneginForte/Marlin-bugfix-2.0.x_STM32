...
#define U8G_COM_HAL_SW_SPI_FN u8g_com_null_fn //u8g_com_arduino_sw_spi_fn
...
#define U8G_COM_ST7920_HAL_HW_SPI u8g_com_stm32duino_st7920_hw_spi_fn //u8g_com_stm32duino_hw_spi_fn
#define U8G_COM_HAL_HW_SPI_FN u8g_com_stm32duino_hw_spi_fn

  //uint8_t u8g_com_HAL_LPC1768_ssd_hw_i2c_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr);
#define U8G_COM_SSD_I2C_HAL u8g_com_stm32duino_ssd_i2c_fn

#if defined(STM32F1) || defined(STM32F1xx) && STM32_HAVE_FSMC
    //uint8_t u8g_com_stm32duino_hw_spi_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr);
    #define U8G_COM_HAL_FSMC_FN u8g_com_null_fn //u8g_com_stm32duino_fsmc_fn
#else
